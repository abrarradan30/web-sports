<template>
  <div class="max-w-6xl mx-auto px-4 py-10 grid lg:grid-cols-3 gap-8">
    ...
    <div class="lg:col-span-2 space-y-10">
      ...
      <a href="https://hellosehat.com/kebugaran/kardio/rekomendasi-sepatu-running-terbaik/" target="_blank" rel="noopener noreferrer" class="grid md:grid-cols-2 gap-6 no-underline text-inherit">
        ...
        <div>
          ...
          <p class="text-xs text-gray-400 mt-2">Kamis, 01 Mei 2025</p>
        </div>
      </a>
      ...
      <a href="https://www.fwd.co.id/id/fwdmax/passionstory-sport/6-olahraga-terbaik-untuk-kesehatan-mental/" target="_blank" rel="noopener noreferrer" class="grid md:grid-cols-2 gap-6 no-underline text-inherit">
        ...
        <div>
          ...
          <p class="text-xs text-gray-400 mt-2">Kamis, 19 Oktober 2023</p>
        </div>
      </a>
      ...
      <a href="https://hellosehat.com/kebugaran/kardio/rekomendasi-sepatu-running-terbaik/" target="_blank" rel="noopener noreferrer" class="grid md:grid-cols-2 gap-6 no-underline text-inherit">
        ...
        <div>
          ...
          <p class="text-xs text-gray-400 mt-2">Minggu, 16 Juni 2024</p>
        </div>
      </a>
    ...
    <div>
      ...
      <!-- Popular 1 -->
      <a href="https://www.klikdokter.com/gaya-hidup/sehat-bugar/beragam-manfaat-di-balik-jogging-setiap-hari?srsltid=AfmBOopN0Aftg5U025BXF3mZ-oIB42nEcE0a_4ITBBgMidtZQiDaVlnv" target="_blank" rel="noopener noreferrer" class="flex items-center mb-4 gap-3 no-underline text-inherit">
        <img
      ...
      <!-- Popular 2 -->
      <a href="https://www.rri.co.id/kesehatan/798122/jenis-olahraga-yang-cocok-bagi-wanita-karier" target="_blank" rel="noopener noreferrer" class="flex items-center mb-4 gap-3 no-underline text-inherit">
        <img
      ...
      <!-- Popular 3 -->
      <a href="https://www.ruparupa.com/blog/tips-bersepeda-aman/" target="_blank" rel="noopener noreferrer" class="flex items-center mb-4 gap-3 no-underline text-inherit">
        <img
